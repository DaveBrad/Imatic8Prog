 ...
 * @author dbradley
 */
public class RelayOnOffUserDirLib extends LibTestClassUserDir {
    ...
    @Override
    String provideUserDirForLibraryTest() {
        return System.getProperty("user.dir") + "/libModeTestDir";
    }

    @BeforeClass
    public void allocResource() {
    ...
    public void noB2IniFile() {
        // create the library object which will allow lib-mode testing of the
        // Imatic8Prog application.
        //
        libObject = new Imatic8LibMode();
        libObject.setUserDir(Im8BoardIniTest.getTestUserDir());

        // use the library to do a function
